...
describe('bOtherExistsOnBottomRight', () => {
  describe('White Source Piece', () => {
    it('returns an object { targetPiece: { nRow, nCol }, pieceExists: true } \
      if a black piece exists on the bottom right diagonal from a given source', () => {
      // Arrange
...
describe('bIsValidCapture', () => {
  ...
  describe('Black King Capture', () => {
    it('returns true if a king capture attempt is valid', () => {
      ...
      board[4][0] = {
        nRow: 5, nCol: 1, bHasWhiteChip: false, bHasBlackChip: true, bHasWhsiteKing: false, bHasBlackKing: true
      }
