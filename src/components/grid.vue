...
export default {
  ...
  methods: {
    ...
    async runTimeForCreatedHook() {
      ...
      const shouldRunSelfTime = (this.bIsFirstRun && this.isSelfWhite) || playerToMove === 'self'

      if (!isTimeRunning && shouldRunSelfTime) {
    ...
    async startEnemyTime() {
      ...
      console.log(isEnemyServerTimeRunning)
